...
static void		mini_sorting_four_b_seven(t_meta *m, unsigned comb)
{
...
static void		mini_sorting_four_b_six(t_meta *m, unsigned comb)
{
...
static void		mini_sorting_four_b_five(t_meta *m, unsigned comb)
{
